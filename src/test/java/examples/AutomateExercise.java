...
public class AutomateExercise {
    ...
    public void checkDate() {
        ...
        driver.findElement(By.cssSelector("input#input-date-modified+span.input-group-btn button.btn")).click();
      //  driver.findElement(By.cssSelector("div.bootstrap-datetimepicker-widget.dropdown-menu.pull-right.picker-open.bottom div.datepicker-days table.table-condensed tbody tr td.day.active.today"));
